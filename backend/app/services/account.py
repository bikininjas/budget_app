...
class AccountService:
    ...
    async def get_all(
        self, skip: int = 0, limit: int = 100, user: User | None = None
    ) -> list[Account]:
    ...
    async def update(
        self, account_id: int, account_data: AccountUpdate, user: User | None = None
    ) -> Account | None:
    ...
    async def add_funds(
        self, account_id: int, amount: float, user: User | None = None
    ) -> Account | None:
